...
class UserController extends Controller
{
    ...
    {
        $users = User::where('executive_id',Auth::user()->id)->get();
        return view('executive.user.index',compact('users'));
    }
    ...
    {
        return view('executive.user.create');
    }
    ...
    {
        $user = User::find($id);
        return view('executive.user.show',compact('user'));
    }
